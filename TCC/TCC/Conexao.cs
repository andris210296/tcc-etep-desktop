...
namespace TCC
{
    abstract class Conexao
    {
        ...
        public static String criar_Conexao()
        {
            ...
            string configuracao = string.Format("server={0};user id={1}; password={2};database=mysql; pooling=false", "172.16.8.237", "root", "ALUNOS");
            ...
            MySqlCommand usar = new MySqlCommand("use satcar", conectar);
